...
local c = require("github-dark-plus.palette")
...
M.setup = function()
    return {
        ...
        ['@exception'] = { fg = c.red },
        ['@variable'] = { fg = c.fg },
        ['@variable.builtin'] = { fg = c.yellow_dark },
        ...
        -- Lualine
        lualine_a_normal = { fg = c.bg, bg = c.blue },
        lualine_b_normal = { fg = c.fg, bg = c.bg_lighter },
        lualine_c_normal = { fg = c.fg_dim, bg = c.bg },
        ...
        -- Treesitter Context
        TreesitterContext = { bg = c.bg_blue },
    }
end
